...
<body>
  <section class="mbr-section content1 cid-rUJmYTNurf" id="content1-n">



      <div class="mbr-container">
          <h2 class="mbr-title align-center mbr-fonts-style mbr-bold display-1">ADS APPEAR HERE</h2>


      </div>
  </section>
  <section class="content16 mbr-section article cid-rUJ5fS85z5" id="content16-8">



    <div class="container">
        <div class="mbr-text align-center mbr-fonts-style mbr-white mbr-bold display-2"><em>Unique Id</em><br><em><br></em></div>
        <?php
        $url="http://localhost/sayaboutme/say.php?username=".$username;
				echo "<center><h1>$url</h1></center>";
        echo '<h1><center><textarea id="myInput" >'.$url.' </textarea>';
        echo "<center><br><br><button onclick='myFunction()'>Copy To Clipboard</button><center>";
...
<section class="engine"><a href="https://mobirise.info/z">best free css templates</a></section><section class="mbr-section content18 cid-rUJcLzjpoa" id="content18-e">



    <div class="mbr-container">
        <h2 class="mbr-title align-center mbr-fonts-style mbr-bold mbr-white display-1">Your Messages Appear Here</h2>
...
$username=$_POST['username'];
        ...
        $sqlsync1=mysql_query($sql,$db_info);
        if(!$sqlsync){
          die("Mysqlerror".mysql_error());
        }
        echo"<link rel='stylesheet' href='margin.css'>";
        echo"<table border='+1'> <center><tr><th>Likes</th><th>Dislikes</th></tr>";
			
echo $sqlresult_set['likes'];
        while($sqlresult_set=mysql_fetch_array($sqlsync1,MYSQL_ASSOC)) {
echo "hy";

            $name=$sqlresult_set['likes'];
            $phone=$sqlresult_set['dislikes'];
								echo "<td>hy</td>";
                echo "<th>$name</th>";
                echo "<th>$phone</th>";
